...
return [
    ...
    'app_default_editor_desc' => '選擇編輯新頁面時默認使用的編輯器。這可以在權限允許的葉面級別被覆蓋。',
    ...
    'app_footer_links' => '頁面底部連結',
    'app_footer_links_desc' => '新增連結以在網站底部顯示。這些將會顯示在大多數頁面的底部，包含那些不需要登入的頁面。您可以使用 "trans::<key>" 標籤來使用系統定義的翻譯。舉例來說：使用 "trans::common.privacy_policy" 將會提供已翻譯的文字「隱私權政策」，以及 "trans::common.terms_of_service" 將會提供已翻譯的文字「服務條款」。',
    'app_footer_links_label' => '連結標籤',
    'app_footer_links_url' => '連結網址',
    'app_footer_links_add' => '新增底部連結',
    ...
    'maint_send_test_email_mail_greeting' => '電子郵件傳送似乎有效！',
    ...
    'roles_index_desc' => '角色用於對用戶進行分組並為其成員提供系統權限。 當用戶是多個角色的成員時，授予的權限將疊加，用戶將繼承所有能力。',
    'roles_x_users_assigned' => '1 位用戶已分配|:count 位用戶已分配',
    'roles_x_permissions_provided' => '1 個權限|:count 個權限',
    ...
    // Users
    'users' => '使用者',
    'users_index_desc' => '在系統內創建和管理個人用戶帳戶。 用戶帳戶用於內容和活動的登錄和歸屬。訪問權限主要基於角色，但用戶內容所有權等因素也可能影響權限和訪問。.',
    ...
    'users_mfa_x_methods' => ':count 個方法已配置|:count 個方法已配置',
    ...
    'webhooks_x_trigger_events' => '1 個事件觸發|:count 個事件觸發',
